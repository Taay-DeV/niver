...
window.alert("Preparada para essa mini aventura?");
let resposta = prompt();
if(resposta === "sim"){
  alert("Nessa primavera flores estão lindas, Se eu te elogiar muito vai parecer apologia. Hoje o mundo para pra ver seu dia, me faltam palavras pra dizer quão grande essa alegria. O céu estrelado, você é tão incrível vou te chamar de saturno. Entre os oito planetas, prefiro te chamar de meu mundo. Feliz aniversário princesa, olhe a beleza que você tem, te desejo o mundo e nesse mundo eu também. Aproveita esse protótipo do jogo :) ");
} else {
  alert("Perdeu a bênção!")
}
